...
def test_flibe(): #test the hdf5 export function
    ...
    compare_ref(Tmin = 400,
               Tmax = 1600,
               thresh = 1e-2,
               salt = salt,
               ref_file= "ref_FluidTest_FLiBe_UF4.h5",
               test_file= "FluidTest_FLiBe_UF4.h5")
...
def test_hitec(): #test the hdf5 export function
    ...
    compare_ref(Tmin = 475,
               Tmax = 700,
               thresh = 1e-2,
               salt = salt,
               ref_file= "ref_FluidTest_Hitec.h5",
               test_file= "FluidTest_Hitec.h5")
'''
        try:
            compare_group(test_file, ref_file)
        except:
