...
def test_Cyl1():
    ...
    for i in range(cyl._x.size):
        assert(np.isclose(cyl._x[i]**2 + cyl._y[i]**2, R**2) or
               cyl._x[i] == cyl._y[i] == 0)
...
def test_Cyl2():
    ...
    for i in range(cyl._x.size):
        assert(round(cyl._x[i]**2 + cyl._y[i]**2) == R**2 or
               cyl._x[i] == cyl._y[i] == 0)
        assert(cyl._z[i] == 0 or cyl._z[i] == 3 or
               cyl._z[i] == 6 or cyl._z[i] == L)
...
def test_Nozzle1():
    ...
    for i in range(nozzle._x.size):
        assert(round(nozzle._x[i]**2 + nozzle._y[i]**2) == Rin**2  or
               round(nozzle._x[i]**2 + nozzle._y[i]**2) == Rout**2 or
               nozzle._x[i] == nozzle._y[i] == 0)
...
def test_Annulus1():
    ...
    for i in range(annulus._x.size):
        assert(round(annulus._x[i]**2 + annulus._y[i]**2) == Rin**2  or
               round(annulus._x[i]**2 + annulus._y[i]**2) == Rout**2)
